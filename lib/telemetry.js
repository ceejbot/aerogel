...
Telemetry.prototype.startMotor = function()
{
	...
	var block =
	{
		...
		variables:
		[
			{ fetchAs: 5, type: this.tableOfContents['motor.m1'].type, id: this.tableOfContents['motor.m1'].id },
			{ fetchAs: 5, type: this.tableOfContents['motor.m2'].type, id: this.tableOfContents['motor.m2'].id },
			{ fetchAs: 5, type: this.tableOfContents['motor.m3'].type, id: this.tableOfContents['motor.m3'].id },
			{ fetchAs: 5, type: this.tableOfContents['motor.m4'].type, id: this.tableOfContents['motor.m4'].id },
		],
	};
...
Telemetry.prototype.startStabilizer = function()
{
	...
	var block =
	{
		...
		variables:
		[
			{ fetchAs: 7, type: this.tableOfContents['stabilizer.roll'].type, id: this.tableOfContents['stabilizer.roll'].id },
			{ fetchAs: 7, type: this.tableOfContents['stabilizer.pitch'].type, id: this.tableOfContents['stabilizer.pitch'].id },
			{ fetchAs: 7, type: this.tableOfContents['stabilizer.yaw'].type, id: this.tableOfContents['stabilizer.yaw'].id },
			// { storage: 7, type: this.tableOfContents['stabilizer.thrust'].type, id: this.tableOfContents['stabilizer.thrust'].id },
		],
	};
