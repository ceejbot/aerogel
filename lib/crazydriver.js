...
CrazyProtocolDriver.prototype.handleConsole = function(packet)
{
...
CrazyProtocolDriver.prototype.telemetryReady = function()
{
	this.telemetryDeferred.resolve('OK');
};

CrazyProtocolDriver.prototype.onStabilizerTelemetry = function(subfunc)
{
	this.telemetry.addSubscriber(subfunc, 'stabilizer');
};

CrazyProtocolDriver.prototype.onMotorTelemetry = function(subfunc)
{
...
CrazyProtocolDriver.prototype.requestTelemetryElement = function(id)
{
	var packet = new Crazypacket();
	packet.port = Crazypacket.Ports.LOGGING;
	packet.channel = Crazypacket.Channels.TOC;
...
CrazyProtocolDriver.prototype.createTelemetryBlock = function(block)
{
	var packet = new Crazypacket();
	packet.port = Crazypacket.Ports.LOGGING;
	packet.channel = Crazypacket.Channels.SETTINGS;
...
CrazyProtocolDriver.prototype.enableTelemetryBlock = function(block)
{
	var packet = new Crazypacket();
	packet.port = Crazypacket.Ports.LOGGING;
	packet.channel = Crazypacket.Channels.SETTINGS;
