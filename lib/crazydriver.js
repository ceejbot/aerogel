...
{
	this.radio.addListener('logging', this.handleTelemetry.bind(this));
...
5:0 (1, 9, 210, 73, 32, 137, 8, 64)
*/

CrazyProtocolDriver.prototype.handleTelemetry = function(packet)
{
	console.log('driver got telemetry packet for channel ' + packet.channel);
