...
CRTPPacket.prototype.getHeader = function()
{
	return this.data[0];
};

CRTPPacket.prototype.setHeader = function(value)
{
	this.data[0] = value;
	return this;
}

CRTPPacket.prototype.__defineGetter__('header', CRTPPacket.prototype.getHeader);
CRTPPacket.prototype.__defineSetter__('header', CRTPPacket.prototype.setHeader);
...
CRTPPacket.LoggingHeaders =
{
	TOC: 80 | 0x3 << 2, // ((0x05 & 0x0F) << 4),
	SETTINGS: 81 | 0x3 << 2,// ((0x05 & 0x0F) << 4) | 1,
	DATA: 82 | 0x3 << 2// ((0x05 & 0x0F) << 4) | 2,
}
