...
Copter.prototype.ready = function()
{
	this.emit('ready');
};
...
Copter.prototype.startTelemetry = function()
{
	...
	this.driver.startTelemetry()
	.then(function()
	{
		self.driver.onStabilizerTelemetry(self.handleTelemetry);
		self.driver.onMotorTelemetry(self.handleTelemetry);
		self.emit('ready');
	})
	.fail(function(err)
	{
...
Copter.prototype.handleTelemetry = function(data)
{
	// TODO
};
